...
const fs = require("fs");
const { getAssets, getCachedAssets } = require('./assetUtils');
const { viewportConfigurations } = require('./config');


(async () => {
  const url = "https://www.peacockindia.in/";
  ...
  // Get the assets using the utility function
  ...
  // Include the assets in your result
